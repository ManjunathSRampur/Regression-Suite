...
public class PlanGenerationSC01 {
	...
	private By scenario01Option = By.xpath("//a[contains(text(),' SC-01 ')]");
...
//-------------------------------------------------------------------------------------------
	public PlanGenerationSC01(WebDriver driver) {
		this.driver = driver;
...
//Plan generation with sc0 starts here
	public boolean createAnewPlanScenario1() throws InterruptedException {
		...
		driver.findElement(planDescInput).sendKeys("Plan Generation Test with scenario 1");
...
//					System.out.println("2nd line"+ ans);
	...
	// Algo Validation for sc1 after Normal Autoschedule
	public boolean algoAuditorSc1_DB_Validation_ForAutoSchedule() throws InterruptedException, SQLException {
		String plID1;
		boolean f = false;

		String category1 = "SCENARIO 1";
		Thread.sleep(3000);
		ArrayList<String> st = new ArrayList<String>(driver.getWindowHandles());
		driver.switchTo().newWindow(WindowType.TAB);
		Thread.sleep(1500);
	...
	// Algo Validation for sc1 after Moving Batch Autoschedule
	public boolean algoAuditorSc1_DB_Validation_ForMoveBatchAutoSchedule() throws InterruptedException, SQLException {
		String plID1;
		boolean f = false;
		System.out.println("algoAuditorSc1_DB_Validation_ForMoveBatchAutoSchedule started");
		String category1 = "SCENARIO 1";
		Thread.sleep(3000);
		ArrayList<String> st = new ArrayList<String>(driver.getWindowHandles());
		driver.switchTo().newWindow(WindowType.TAB);
	...
	// Algo Validation for sc1 after equipment unavailable Autoschedule
	public boolean algoAuditorSc1_DB_Validation_ForEquipmentUnavailableAutoSchedule()
			throws InterruptedException, SQLException {
		String plID1;
		boolean f = false;
		System.out.println("algoAuditorSc1_DB_Validation_ForEquipmentUnavailableAutoSchedule started");
		String category1 = "SCENARIO 1";
		Thread.sleep(3000);
		ArrayList<String> st = new ArrayList<String>(driver.getWindowHandles());
		driver.switchTo().newWindow(WindowType.TAB);
